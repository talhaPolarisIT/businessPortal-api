...
export default () => {
  ...
  return {
    ...
    register: async (req: Request, res: Response) => {
      const { name, email, password, country, userGroupCodes, isCheckReq, isPasswordUpdated } = req.body;
      try {
        ...
        const user = await User.create({ name, email, password: hash, country, userGroupCodes, isCheckReq, isPasswordUpdated });
